...
- `smoke` project: `e2e/novelwriter.smoke.quick.spec.js`
- `smoke-full` project: `e2e/novelwriter.smoke.spec.js`
- `regression` project: `e2e/novelwriter.regression.spec.js`, `e2e/herbalbookforge.regression.spec.js`
